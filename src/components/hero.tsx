...
const Hero: FunctionComponent = () => {
  return (
    <header className="fm-flex fm-flex-col fm-justify-around lg:fm-justify-center fm-h-screen fm-px-[50px] fm-py-[70px] lg:fm-p-0 fm-text-2xl max-[320px]:fm-text-xl lg:fm-text-4xl fm-tracking-widest fm-leading-normal lg:fm-leading-relaxed selection:fm-bg-yellow-400 dark:selection:fm-text-neutral-950">
